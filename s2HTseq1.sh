...
bam_file_dir=/home/prze1839/genome_analysis/DNA/Mapping_Analysis/sorted_bins/s2_sorted_bins
...
do 
	htseq-count -f bam -r pos -t CDS -i ID --stranded=no $bam_file_dir/s2_sorted_${bin}.bam $gff_file_dir/${bin}.gff.nofa > $out_dir/${bin}_count.out
done
